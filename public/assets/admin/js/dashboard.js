(function($) {
    ...
    $.ajax({
        ...
        success: function (response, status, xhr) {
          ...
          if ($("#order-chart").length) {
            ...
            var areaData = {
              labels: responseData.order_info.group_order,
              datasets: [
                {
                  data: responseData.order_info.group_revenue,
                  borderColor: [
                    '#4747A1'
                  ],
                  borderWidth: 2,
          ...
          if ($("#sales-chart").length) {
            ...
            var SalesChart = new Chart(SalesChartCanvas, {
              type: 'bar',
              data: {
                labels: responseData.sales_info.month,
                datasets: [{
                    label: 'Total Sales',
                    data: responseData.sales_info.orders_by_month,
  ...
  //   "ajax": "/public/assets/admin/js/data.txt",
  //   "columns": [
  //       { "data": "Quote" },
  //       { "data": "Product" },
  //       { "data": "Business" },
