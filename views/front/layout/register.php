...
?>
        <script>
            ...
            var result = "<?=$result == 1 ? "Account Created Successfully" : $result?>"
            alert(result);
        ...
        <div class="customer-details">
          ...
          <div class="form-group mt-4">
            ...
            <label for="customer_image">
              <img src="/public/assets/no_image.png" style="width:150px; height:150px" class="image-input border border-1" />
            </label>
            <input type="file" class="d-none" name="customer_image" id="customer_image" onChange="chooseImage(event)" />
          </div>
          <div class="form-group mt-4">
      ...
      <div class="col-lg-5 col-12 mx-5">
        <div class="address-details">
          ...
          <div class="d-flex my-4">
            <button type="submit" class="btn btn-dark w-100">Sign up for an Account</button>
          </div>
