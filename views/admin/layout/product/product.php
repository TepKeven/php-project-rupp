<?php
  ...
  if(isset($_POST) && !empty($_POST)){
      ...
      $product_ids = json_decode( $_POST["deleted_product_ids"]);

      $result = Product::delete($product_ids);
        ...
        <div class="content-wrapper">
          <div class="row">    
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card form-product" id="form-product">
                <div class="card-body">
                <div class="page-heading d-flex align-items-center justify-content-between">
                  <h3>Product</h3>
                  <div class="pull-right">
                    <a href="/admin/product/add" data-toggle="tooltip" title="New" class="btn btn-info" data-original-title="Save"><i class="ti-plus"></i></a>
                    <a href="#" data-toggle="tooltip" title="Delete" class="btn btn-danger" data-original-title="Delete" onclick="deleteProducts()"><i class="ti-trash"></i></a>
                  </div>
                </div>
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered table-hover">
                      ...
                      ?>          
                            <tr>
                                <td scope="col" class="text-center align-middle"><input type="checkbox" class="table-checkbox" name="product_checkbox[]" value=<?=$row["product_id"]?> /></td>
                                ...
                                <td class="text-center align-middle">
                                    <a href="/admin/product/edit?product_id=<?=$row["product_id"]?>" title="Edit" class="btn btn-primary p-2"><i class="ti-pencil"></i></a>
                                </td>
                            </tr> 
                      <?php 
