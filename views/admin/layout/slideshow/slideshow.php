<?php
  ...
  if(isset($_POST) && !empty($_POST)){
      ...
      $slideshow_ids = json_decode( $_POST["deleted_slideshow_ids"]);

      $result = Slideshow::delete($slideshow_ids);
        ...
        <div class="content-wrapper">
          <div class="row">    
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card form-slideshow" id="form-slideshow">
                <div class="card-body">
                <div class="page-heading d-flex align-items-center justify-content-between">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered table-hover">
                      ...
                      ?>          
                            <tr>
                                <td scope="col" class="text-center align-middle"><input type="checkbox" class="table-checkbox" name="slideshow_checkbox[]" value=<?=$row["slideshow_id"]?> /></td>
                                <td scope="row" class="text-center align-middle"><?=$i?></td> 
                                <td class="text-center align-middle">
                                  <img src=<?=$row["image"] == null ? "/public/assets/no_image.png" : "/public/images/slideshow/" . $row["image"]?> width="100" height="100" />
                                </td>
                                <td class="text-center align-middle"><?=$row["title"]?></td>
                                <td class="text-center align-middle"><?=$row["description"]?></td>
                                <td class="text-center align-middle"><?=$row["link"] ?></td>
                                <td class="text-center align-middle"><?=$row["sort_order"]?></td>
                                <td class="text-center align-middle"><?=$row["status"]?></td>
                                <td class="text-center align-middle">
                                    <a href="/admin/slideshow/edit?slideshow_id=<?=$row["slideshow_id"]?>" title="Edit" class="btn btn-primary p-2"><i class="ti-pencil"></i></a>
                                </td>
                            </tr> 
                      <?php 
