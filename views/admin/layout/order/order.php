<?php
  ...
  if(isset($_POST) && !empty($_POST)){
      ...
      $order_ids = json_decode( $_POST["deleted_order_ids"]);

      $result = Order::delete($order_ids);

      if($result){
        
        $order_product_result = OrderProduct::deleteByOrderIds($order_ids);

      }

      return $result && $order_product_result;
        ...
        <div class="content-wrapper">
          <div class="row">    
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card form-order" id="form-order">
                <div class="card-body">
                <div class="page-heading d-flex align-items-center justify-content-between">
                  <h3>Order</h3>
                  <div class="pull-right">
                    <a href="/admin/order/add" data-toggle="tooltip" title="New" class="btn btn-info" data-original-title="Save"><i class="ti-plus"></i></a>
                    <a href="#" data-toggle="tooltip" title="Delete" class="btn btn-danger" data-original-title="Delete" onclick="deleteOrders()"><i class="ti-trash"></i></a>
                  </div>
                </div>
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered table-hover">
                      ...
                      ?>          
                            <tr>
                                <td scope="col" class="text-center align-middle"><input type="checkbox" class="table-checkbox" name="order_checkbox[]" value=<?=$row["order_id"]?> /></td>
                                ...
                                <td class="text-center align-middle"><?=$row["country"]?></td>
                                <td class="text-center align-middle"><?=$row["total"]?></td>
                                <td class="text-center align-middle"><?=$row["ip"] == "::1" ? "127.0.0.1" : $row["ip"] ?></td>
                                <td class="text-center align-middle"><?=OrderStatus::findOne($row["order_status_id"])["name"] ?></td>
                                <td class="text-center align-middle">
                                    <a href="/admin/order/edit?order_id=<?=$row["order_id"]?>" title="Edit" class="btn btn-primary p-2"><i class="ti-pencil"></i></a>
                                </td>
                            </tr> 
                      <?php 
