                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="order_first_name" name="order_first_name" value="<?=$result["first_name"]?>" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="order_last_name" name="order_last_name" value="<?=$result["last_name"]?>" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="order_email" name="order_email" value="<?=$result["email"]?>" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="order_telephone" name="order_telephone" value="<?=$result["telephone"]?>" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="order_customer_id" name="order_customer_id">
                                        ...
                                        ?>
                                                <option value=<?=$customer["customer_id"]?> <?=$customer["customer_id"] == $result["customer_id"] ? "selected" : "" ?> ><?=$customer["first_name"] . " " . $customer["last_name"] ?></option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="order_company" name="order_company" value="<?=$result["company"]?>" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="order_address" name="order_address" value="<?=$result["address"]?>" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="order_city" name="order_city" value="<?=$result["city"]?>" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="order_country_id" name="order_country_id">
                                        ...
                                        ?>
                                                <option value=<?=$country["country_id"]?> <?=$country["country_id"] == $result["country_id"] ? "selected" : "" ?> ><?=$country["name"] ?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="order_payment_id" name="order_payment_id">
                                        ...
                                        ?>
                                                <option value=<?=$payment["payment_id"]?> <?=$payment["payment_id"] == $result["payment_id"] ? "selected" : "" ?> ><?=$payment["name"]?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="order_shipping_id" name="order_shipping_id">
                                        ...
                                        ?>
                                                <option value=<?=$shipping["shipping_id"]?> <?=$shipping["shipping_id"] == $result["shipping_id"] ? "selected" : "" ?> ><?=$shipping["name"]?></option>
...
<script>
    window.onload = function(){
        ...
        getProductsToOrder(params.get("order_id"));
    }
</script>